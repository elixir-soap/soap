defmodule Soap.Wsdl do
  ...
  defp parse(wsdl) do
    ...
    parsed_response = %{
      ...
      validation_types: get_validation_types(wsdl, protocol_namespace)
    }
  ...
  def get_validation_types(wsdl, protocol_ns) do
    xpath(wsdl, ~x"//#{protocol_ns}:types/xsd:schema/xsd:complexType"l)
